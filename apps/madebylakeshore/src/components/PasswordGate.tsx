      ...
      <div className="w-full max-w-md mx-auto px-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full px-4 py-3 bg-mbl-dusk text-mbl-ink font-heading font-medium rounded-lg hover:bg-mbl-slate hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
